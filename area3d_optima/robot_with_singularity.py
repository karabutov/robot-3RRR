...
box.MAX_SIZE = [0.1, 0.1, math.pi/16]
...
boxes, singularity = areaotim.calculate_with_singularity(np.empty((0,), dtype=np.object), np.empty((0,), dtype=np.object), initial_box)
